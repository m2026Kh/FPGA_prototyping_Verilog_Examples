...
set_property PACKAGE_PIN V17 [get_ports BCD_in[0]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[0]];
set_property PACKAGE_PIN V16 [get_ports BCD_in[1]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[1]];
set_property PACKAGE_PIN W16 [get_ports BCD_in[2]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[2]];
set_property PACKAGE_PIN W17 [get_ports BCD_in[3]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[3]];
set_property PACKAGE_PIN W15 [get_ports BCD_in[4]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[4]];
set_property PACKAGE_PIN V15 [get_ports BCD_in[5]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[5]];
set_property PACKAGE_PIN W14 [get_ports BCD_in[6]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[6]];
set_property PACKAGE_PIN W13 [get_ports BCD_in[7]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[7]];
set_property PACKAGE_PIN V2 [get_ports BCD_in[8]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[8]];
set_property PACKAGE_PIN T3 [get_ports BCD_in[9]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[9]];
set_property PACKAGE_PIN T2 [get_ports BCD_in[10]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[10]];
set_property PACKAGE_PIN R3 [get_ports BCD_in[11]];
set_property IOSTANDARD LVCMOS33 [get_ports BCD_in[11]];
